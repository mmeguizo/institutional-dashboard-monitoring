...
export class AddGoalComponent implements OnInit, OnDestroy {
    ...
    customstrageticObjectiveName: string; // Added
    originalStrategicObjective: any; // Added
    filteredStrategicObjectiveList: any; // Added
    ...
    createAddGoalForm() {
        this.addGoalform = this.formBuilder.group({
            ...
            strategic_objective: ['', [Validators.required]], // Added
    ...
    addGoalDialogExec(form: FormGroup) {
        let data = {
            ...
            strategic_objective:
                ...
                this.customstrageticObjectiveName, // Added
            strategic_id: form.value.strategic_objective.id, // Added
